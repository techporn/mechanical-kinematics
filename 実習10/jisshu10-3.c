...
int main(int argc, char** argv)
{
	...
	for(tim=0; tim<=10; tim+=dt)
	{
		...
		k2_1= func1(x1_k+k1_1/2, x2_k+k1_2/2)*dt;
		k2_2= func2(x1_k+k1_1/2, x2_k+k1_2/2)*dt;
		k3_1= func1(x1_k+k2_1/2, x2_k+k2_2/2)*dt;
		k3_2= func2(x1_k+k2_1/2, x2_k+k2_2/2)*dt;
		k4_1 = func1(x1_k+k3_1, x2_k+k3_2)*dt;
		k4_2 = func2(x1_k+k3_1, x2_k+k3_2)*dt;
